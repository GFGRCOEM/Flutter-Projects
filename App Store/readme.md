...
## **Problem Statement: App Store** :sparkles:
 - User should be able to login and sign up using mail.
 - User should be able to view applications according to differnt categories like buisness,communication etc.
 - User should be able to install applications.
 - User should be able to write a reivew and give rating out of 5.
 - User should be able to search different applications.
 - User should be able to Update thier own application in your app store.
