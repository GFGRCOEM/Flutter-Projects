...
## **Problem Statement: Social Place** :sparkles:
 - User should be able to Sign up and Sign in.
 - User should be able to Send friend request and recieve Freind request from others.
 - User should be able to Edit the Profile and can add display picture to it.
 - User should be able to Form a Group chat.
 - User should be able to delete message and block user and remove Friend.
 - User should be able to archive chats.
 - User should be able to post images and videos.
 - User should be able to view other feeds and Profile.
